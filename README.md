...
### NAACL 2015 Chinese Annotated Excel data to CSV
...
``` bash
uv run scripts/naacl_2015_chinese_excel_to_csv.py --help
                                                                                                                                                                                                                                                                                                                                                                                                                                        
 Usage: naacl_2015_chinese_excel_to_csv.py [OPTIONS] FOLDER                                                                                                                                                                                                                                                                                                                                                                             
