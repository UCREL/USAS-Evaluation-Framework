...
class TestSpanishWikipediaUSAS:
    ...
    def test_parse_empty(self, get_test_directory: Path) -> None:
        ...
        assert dataset.name == "Spanish Wikipedia USAS"
    ...
    def test_parse_small_example(
        ...
        dataset = SpanishWikipediaUSAS.parse(
            get_test_directory / data_file_name, label_filter=label_filter
        )
    ...
    def test_parse_full_dataset(self) -> None:
        ...
        dataset = SpanishWikipediaUSAS.parse(data_file, valid_usas_tags, tags_to_filter)
